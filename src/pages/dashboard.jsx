        ...
        <section className="Content">
          ...
          <section className="GraphContainer">
            <article className="GraphHead">
              ...
              <SectionTitle
                SecTitle="Analytics Overview"
                SecSubTitle="Monthly performance metrics"
              />
            </article>
          ...
          <section className="RecentContainer">
            <article className="GraphHead">
              ...
              <SectionTitle
                SecTitle="Recent Activities"
                SecSubTitle="Latest updates and activities"
              />
            </article>
